...
x-complete: 0
info:
  title: Azure Data Lake Store API File System Set Permission
...
paths:
  ...
  /webhdfs/v1/{filePath}:
    delete:
      ...
      x-api-path-slug: webhdfsv1filepath-delete
      parameters:
      - in: path
        name: filePath
        description: The Data Lake Store path (starting with /) of the file or directory
  ...
  /webhdfs/v1/{renameFilePath}:
    put:
      ...
      x-api-path-slug: webhdfsv1renamefilepath-put
      parameters:
      - in: query
        name: destination
  ...
  /webhdfs/v1/{setOwnerFilePath}:
    put:
      ...
      x-api-path-slug: webhdfsv1setownerfilepath-put
      parameters:
      - in: query
        name: group
  ...
  /webhdfs/v1/{setPermissionFilePath}:
    put:
      ...
      x-api-path-slug: webhdfsv1setpermissionfilepath-put
      parameters:
      - in: query
        name: No Name
      - in: query
